...
export const sendInvitation = async (
  ...
  // 1 Agency per email address
  // if a user is invited he cannot create his own agency
  // so we will check when user checks in o the dashboard
  // whether he has an invite or not
